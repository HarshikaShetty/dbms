<%-- 
    ...
    Created on : Feb 23, 2016, 12:18:41 AM
    Author     : Oops
--%>
...
<pre style="background-image:url(images/th(4).jpg);background-repeat: no; ">
<center>

<h1 style="color:red;font-family:serif;  ">Registration successful go for login
    
  
    <a href="http://localhost:8080/bloodbms/index.html"  style=" size: 400px;"><button style="width:100px;height:30px;background-color:yellowgreen;">Login</button></a>
