...
<div id="tooplate_middle_subpage">
                             <h1 style="margin-left:370px;">Registration Form For bloodbank</h1> 		
</div> <!-- end of middle -->
...
margin-left: 200px;
background-image:url(images/th(4).jpg);
color: blue; 
font-size: 23px;
...
<div id="tooplate_footer_wrapper">
	<div id="tooplate_footer">
        ...
        <div class="col_w200 float_l">
            ...
            <ul class="tooplate_list"> 
                <li><a href="#"> INAZ </a></li>
                <li><a href="#">FATHIMATH ZULFA</a></li>
                <li><a href="#">HARSHIKA</a></li>
                <li><a href="#">MISHAL</a></li>
                 <li><a href="#">MAYA</a></li>
